...
export interface BirthDetails { name: string; date: string; time: string; ampm: string; place: string; latitude: number | null; longitude: number | null; gender: "male" | "female" | ""; timezone_offset?: number; }
